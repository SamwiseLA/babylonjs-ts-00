...
export default class MyScene {
    constructor(canvasElement) {
        this.yeti = [undefined, undefined, undefined];
        this.alien = undefined;
        this.object = [undefined, undefined, undefined];
        this.objectFileURL = [
    ...
    createScene() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const uri = "https://dl.dropbox.com/s/rgm7xqiguux0t0d/Girl%20From%20Ipanema%20-%20Frank%20Sinatra.mp3";
            //this.appMain.music = new BABYLON.Sound("cello", "sounds/cellolong.wav", this.appMain._scene, null, { loop: true, autoplay: true });
            this.music = new BABYLON.Sound("sound1", uri, this._scene, null, { loop: true, autoplay: true, volume: 0.05 });
            ...
            var rot = new BABYLON.Vector3(BABYLON.Angle.FromDegrees(0).radians(), BABYLON.Angle.FromDegrees(90).radians(), BABYLON.Angle.FromDegrees(0).radians());
            this.OBJMod.SpawnYeti(0, pos, sca, rot);
            // Yeti: 1
            pos = new BABYLON.Vector3(4, 0, 0);
            sca = new BABYLON.Vector3(0.025, 0.04, 0.04);
            rot = new BABYLON.Vector3(BABYLON.Angle.FromDegrees(0).radians(), BABYLON.Angle.FromDegrees(-90).radians(), BABYLON.Angle.FromDegrees(0).radians());
            this.OBJMod.SpawnYeti(1, pos, sca, rot);
            // Alien
            pos = new BABYLON.Vector3(1, 2, -0.5);
            sca = new BABYLON.Vector3(1, 1, 1);
            rot = new BABYLON.Vector3(BABYLON.Angle.FromDegrees(20).radians(), BABYLON.Angle.FromDegrees(180).radians(), BABYLON.Angle.FromDegrees(0).radians());
            this.OBJMod.SpawnAlien(pos, sca, rot);
            // Sword
            pos = new BABYLON.Vector3(3, 2.5, 0);
            sca = new BABYLON.Vector3(0.05, 0.05, 0.05);
            rot = new BABYLON.Vector3(BABYLON.Angle.FromDegrees(0).radians(), BABYLON.Angle.FromDegrees(0).radians(), BABYLON.Angle.FromDegrees(0).radians());
