...
export default class MySceneObjects {
    ...
    SpawnGround() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ground = BABYLON.Mesh.CreateGround("ground", 40, 10, 1, this.appMain._scene, false);
            ...
            var groundMaterialShadow = new BABYLON.StandardMaterial("groundShadow", this.appMain._scene);
            ...
            var groundMaterial = new BABYLON.StandardMaterial("ground", this.appMain._scene);
    ...
    SpawnYeti(index, pos, sca, rot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            "Yeti.gltf", this.appMain._scene, function (newMeshes, particleSystems, skeletons) {
    ...
    SpawnAlien(pos, sca, rot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //Assets.meshes.Yeti.filename,
            "Alien.gltf", this.appMain._scene, function (newMeshes, particleSystems, skeletons) {
    ...
    SpawnObj(index, pos, sca, rot) {
        return __awaiter(this, void 0, void 0, function* () {
            this.appMain.METHMod.DMM(`SpawnObj: $(index)`);
            const appMain = this.appMain;
            BABYLON.SceneLoader.ImportMesh("", this.appMain.objectFileURL[index], this.appMain.objectFileName[index], this.appMain._scene, function (newMeshes, particleSystems, skeletons) {
    ...
    LoadVideo() {
        ...
        var videoTexture = new BABYLON.VideoTexture("video", [
            uri,
        ], this.appMain._scene, true, false);
        //videoTexture.getAlphaFromRGB = true;
        mat.emissiveTexture = videoTexture;
        mat.disableLighting = true;
        // Attach the video material the a mesh
        var monitor = BABYLON.MeshBuilder.CreatePlane("monitor1", { height: 18, width: 21 }, this.appMain._scene);
        monitor.scaling.x = 1920 / 1080; // set aspect ratio
        monitor.material = mat;
        monitor.position = new BABYLON.Vector3(0, 6, 48);
        monitor.rotation = new BABYLON.Vector3(0, BABYLON.Angle.FromDegrees(45).radians(), 0);
    ...
    FloorWallArea() {
        ...
        var ground = BABYLON.MeshBuilder.CreateGround("ground", { width: 6, height: 6 }, this.appMain._scene);
        var backWall = BABYLON.MeshBuilder.CreatePlane("backWall", { width: 6, height: 6 }, this.appMain._scene);
        let groundMaterial = new BABYLON.StandardMaterial("Ground Material", this.appMain._scene);
        let backMaterial = new BABYLON.StandardMaterial("Back Material", this.appMain._scene);
        ground.material = groundMaterial;
        backWall.material = backMaterial;
        let groundTexture = new BABYLON.Texture("https://dl.dropbox.com/s/d774xc5km3l1gst/Floor-Stone-Portuguesa-Ground-Texture-Sidewalk-5224213.jpg?dl=0", this.appMain._scene);
        let backTexture = new BABYLON.Texture("https://image.shutterstock.com/image-photo/basalt-stones-background-reynisfjara-beach-600w-2124570419.jpg", this.appMain._scene);
    ...
    BorderHouse() {
        ...
        for (let i = 0; i < fenceXPosts; i++) {
            const fencePost = BABYLON.MeshBuilder.CreateSphere("sphere", { diameter: 0.1, diameterY: height }, this.appMain._scene);
            if (i % 2 === 0) {
...
//# sourceMappingURL=my_scene00_objects.js.map